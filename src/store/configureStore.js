import {createStore, combineReducers,applyMiddleware,compose} from 'redux'; // combine reducers is used when we are using more than one reducers, read about applyMiddleware
